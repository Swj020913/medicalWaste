<template>
  <el-dialog :title="title" :visible="visible" width="60%" :before-close="handleClose">
<el-row>
  <el-form ref="form" :rules="rules" :model="form" label-width="90px">
    <el-col :span="12">
      <el-form-item v-if="isShow" label="所属城镇" prop="townId">
        <el-select :disabled="isDetail" v-model="form.townId" @change="getOrgLists" placeholder="请选择">
    ...
    <el-col :span="12">
      <el-form-item label="机构名称" prop="orgId">
        <el-select
          :disabled="form.townId == undefined && isShow || isDetail"
  ...
  methods: {
    ...
    getDepartList (id) {
      this.orgList.forEach(i => {
        if (i.orgCode == id) this.form.orgName = i.departName
      })
      this.$forceUpdate()
    },
    getOrgLists () {
