<template>
    ...
    <el-form :model="form" ref="form" :inline="true" label-width="100px">
      <el-row>
        <el-col :span="8">
          <el-form-item label="扎带编码">
            <el-input v-model="form.barCode" placeholder="请输入扎带编码" style="width:250px;" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="操作时间">
            <el-date-picker style="width:300px" v-model="bindingTime" type="daterange" unlink-panels range-separator="至"
      ...
      <el-form-item label="流程类型">
        ...
        <el-col :span="8">
          ...
          <a-button size="large" type="primary" @click="rollback" icon="rollback" style="margin:0px">返回</a-button>
        </el-col>
      </el-row>
    </el-form>
  ...
  font-family: monospace, monospace;" v-if="item.processStatus == '4'">
                ...
                <el-image style="width: 200px; height: 160px;margin-left:60px"
                  :src="imgPath + '/' + item.driverAutograph"
  ...
  export default {
    ...
    methods: {
      ...
      getlist() {
        ...
        getYfdFromBoxList(this.form).then(res => {
          if (res.success) {
      ...
      show(item) {
        this.form.temporaryContainerCode = item.boxIdentifyingCode
        this.record = item
        this.getlist()
      },
      rollback() {
      ...
      refresh() {
        this.form = {
          pageNo: 1,
          pageSize: 9,
          temporaryContainerCode: this.record.boxIdentifyingCode
        }
        this.bindingTime = ''
        this.getlist()
      }
