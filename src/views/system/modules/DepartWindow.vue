...
<script>
  ...
  import { queryTreeNode } from '@/api/api'
  ...
  export default {
    ...
    methods: {
      add (checkedDepartKeys,userId,id) {
        this.selectKeys = checkedDepartKeys;
        this.userId = userId;
        this.zzjgId = id
        this.edit({});
      },
      ...
      onCheck(selectKeys, info){
        ...
        console.log('onCheck', selectKeys, info);
      },
      queryDepartTree(){
        queryTreeNode({id:this.zzjgId}).then((res)=>{
          if(res.success){
