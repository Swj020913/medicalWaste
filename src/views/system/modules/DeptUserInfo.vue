<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator" :md="24" :sm="24" style="margin-top: -15px">
      ...
      <a-button @click="handleAddUserDepart" type="primary" icon="plus">添加已有人员</a-button>
      <a-button @click="handleAdd" type="primary" icon="plus" style="margin-top: 16px">新建人员</a-button>
