  ...
  <a-row :gutter="10">
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          <a-button @click="handleAdd(1)" type="primary">添加单位</a-button>
    ...
    <a-col :md="12" :sm="24">
      <a-tabs defaultActiveKey="1">
          ...
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form :form="form">
              <a-form-item
                ...
                label="单位名称">
                <a-input placeholder="请输入单位名称" v-decorator="['departName', validatorRules.departName ]"/>
              </a-form-item>
              ...
              <a-form-item
                ...
                :wrapperCol="wrapperCol"
                label="单位编码">
                <a-input disabled placeholder="请输入单位编码" v-decorator="['orgCode', validatorRules.orgCode ]"/>
              </a-form-item>
              <a-form-item
                :labelCol="labelCol"
                :wrapperCol="wrapperCol"
        ...
        <a-tab-pane tab="单位权限" key="2" forceRender>
