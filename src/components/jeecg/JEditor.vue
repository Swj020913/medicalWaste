...
<script>
  ...
  export default {
    ...
    props: {
      ...
      plugins: {
        type: [String, Array],
        default: 'code lists image link media table textcolor wordcount contextmenu fullscreen'
      },
      toolbar: {
        type: [String, Array],
        default: 'code undo redo | formatselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | forecolor backcolor | lists link unlink image media table | removeformat | fullscreen',
        branding:false
      }
    },
    data() {
